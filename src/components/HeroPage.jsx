    ...
    <div className='bg-gradientBackground py-7'>
      <div className='px-4 md:px-14  mx-auto grid grid-cols-1 md:grid-cols-2'>
        <div data-aos="fade-up">
          ...
          <p className='text-fourty text-black font-bold md:pt-5 leading-tight bg-white inline-block py-4 rounded-md shadow-sm shadow-black px-3'> I am <span className='text-textmaincolor'> Frontend Developer</span></p>
