        ...
        <div className='py-10'>
            <div className='px-4 md:px-14 mx-auto grid grid-cols-1 md:grid-cols-2 '>
                ...
                <div className='order-1 md:order-2'>
                    ...
                    <button onClick={handleDownload} className="block w-full px-10 py-4 mt-5 md:mt-16 text-white bg-buttoncolor rounded-md font-medium text-xl md:inline md:w-auto">
                        RESUME
                    </button>
                </div>
            </div>
